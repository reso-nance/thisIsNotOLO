...
void ICACHE_RAM_ATTR dimmerLampESP8266::timer_init(void)
{
...
void ICACHE_RAM_ATTR dimmerLampESP8266::ext_int_init(void) 
{
...
void ICACHE_RAM_ATTR dimmerLampESP8266::begin(DIMMER_MODE_typedef DIMMER_MODE, ON_OFF_typedef ON_OFF)
{
...
void ICACHE_RAM_ATTR dimmerLampESP8266::setPower(int power)
{	
	if (power >= 99) 
	{
		power = 99;
